...
def findFirst(iForFirst):
     global box2
     while box2 == ():
          box2 = pyautogui.locateOnScreen(iForFirst, confidence=0.70)
          if box2:
...
#findChat(imageForChatLoc)
#findNameLoc(imageForChatLoc)
     ...
     while True:
          if inputNameHasRan:
               ...
               if numOfTrades % 25 == 0:
                    ...
                    pyautogui.click()
                    pyautogui.write(insult[random.randint(len(insult)-1)])
